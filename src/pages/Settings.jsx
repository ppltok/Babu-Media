        ...
        <section className="bg-white/5 border border-white/10 rounded-2xl p-6">
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <div className="text-2xl font-bold">
                  {tierDisplay}
                  {tierName === 'free' && <span className="text-sm font-normal text-gray-400 ml-2">(Free)</span>}
                  {tierName === 'creator' && <span className="text-sm font-normal text-purple-300 ml-2">$9.99/mo</span>}
                  {tierName === 'pro' && <span className="text-sm font-normal text-amber-300 ml-2">$19.99/mo</span>}
                </div>
              </div>
              {tierName !== 'free' && (
          ...
          {usageSummary && (
            <div className="mb-6 space-y-3">
              <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wide">Your Usage</h3>
                ...
                <div className="bg-white/5 rounded-xl p-4">
                  ...
                  <div className="text-sm text-gray-400">
                    ...
                    {usageSummary.characters.period !== 'lifetime' && (
                      <span className="text-xs"> ({usageSummary.characters.period})</span>
                    )}
                  </div>
                </div>
                ...
                <div className="bg-white/5 rounded-xl p-4">
                  ...
                  <div className="text-sm text-gray-400">
                    ...
                    {usageSummary.stories.period !== 'lifetime' && (
                      <span className="text-xs"> ({usageSummary.stories.period})</span>
                    )}
                  </div>
                </div>
              </div>
          ...
          {tierName !== 'free' && (
            <p className="text-sm text-gray-500 mt-4 text-center">
              Click "Manage Subscription" to update payment method, change plan, or cancel.
            </p>
          )}
        </section>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  <th className="text-center py-3 text-gray-400 font-medium">Explorer</th>
                  <th className="text-center py-3 text-purple-400 font-medium">Creator</th>
                  <th className="text-center py-3 text-amber-400 font-medium">Pro</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                <tr>
                  <td className="py-3">Child Profiles</td>
                  <td className="text-center py-3">1</td>
                  <td className="text-center py-3">Unlimited</td>
                  <td className="text-center py-3">Unlimited</td>
                </tr>
                <tr>
                  <td className="py-3">Characters</td>
                  <td className="text-center py-3">2 total</td>
                  <td className="text-center py-3">5/month</td>
                  <td className="text-center py-3">Unlimited</td>
                </tr>
                <tr>
                  <td className="py-3">Stories</td>
                  <td className="text-center py-3">1 total</td>
                  <td className="text-center py-3">10/week</td>
                  <td className="text-center py-3">Unlimited</td>
                </tr>
                <tr>
                  <td className="py-3">Storage</td>
                  <td className="text-center py-3">Basic</td>
                  <td className="text-center py-3">Extended</td>
                  <td className="text-center py-3">Unlimited</td>
                </tr>
              </tbody>
            </table>
